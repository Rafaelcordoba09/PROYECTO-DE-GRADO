...
<html>
  ...
  <body>
    <div class="bg"></div>
    <div class="block">
      <a class="button showForm" href="#">Nuevo Incidente </a>
      <table id="table" class="tables">
        ...
        <tr id="listax"> 
              ...
              <select name="filtrox" id="filtrox">
                  <?php
                    include_once('incidente.list.nodos.php');
                  ?>
              </select>
          </tr>
          <tr>
        ...
        <tbody class="listIncidentes">
          <?php include_once 'incidente.list.php' ?>
        </tbody>
      </table>
    </div>
    <div class="modalFrmIncidente"></div>
  </body>
