...
$objDB = new DataBase;
$nodo=$_GET['id'];
$result = $objDB->Execute("SELECT * FROM tramo where fk_id_nodo='$nodo'");
$result2= $objDB->Execute("SELECT AVG(dir_origen_lat) as lat, AVG(dir_origen_lon) AS lon FROM tramo where fk_id_nodo='$nodo'");
