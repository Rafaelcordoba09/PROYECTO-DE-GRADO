...
<html>
  ...
  <body>
    <div class="bg"></div>
    <div class="block">
      <a class="button showForm" href="#">Nuevo Servicio</a>
      <table id="table" class="tables">
        ...
        <tr id="listax"> 
              ...
              <select name="filtrox" id="filtrox">
                  <?php
                    include_once('servicio.list.nodos.php');
                  ?>
              </select>
          </tr>
          <tr>
            ...
            <th>Frecuencia λ</th>
            <th>Descripción</th>
            <th>Capacidad BW λ</th>
            <th>Asignado a</th>
            <th>Acciones</th>
        </thead>
        <tbody class="listServicios">
          <?php include_once 'servicio.list.php' ?>
        </tbody>
      </table>
    </div>
    <div class="modalFrmServicio"></div>
  </body>
