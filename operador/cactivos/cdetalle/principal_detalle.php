...
<head>
	...
	<title>Detalle de Incidentes</title>
...
<?php include('slidebar.php')?> 
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Detalle del Incidente</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Detalle del Incidente con Ticket No.<?php echo("  ".$_SESSION['incx']);?></h1>
			</div>
		</div><!--/.row-->
