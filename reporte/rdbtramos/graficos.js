$(".graficax1").click(function(event) {
    var ruta;
    var leyenda = "Problemas por Tramo";
    var fechai = document.getElementById("finicial").value;
    var fechaf = document.getElementById("ffinal").value;
    if (fechai != "" && fechaf != "") {
        if ($("#filtrox option:selected").val() != "none") {
            var nodo = $("#filtrox option:selected").val();
            var tramo = $("#filtroy option:selected").val();
            rutax = "ggrafico.php?fi=" + fechai + "&&ff=" + fechaf + "&&ti=" +
                nodo + "&&ti2=r&&ti3=" + tramo
            ggrafico(fechai, fechaf, rutax, leyenda);
        } else {
            alert("Debe Elegir Primero un Nodo");
        }
    } else {
...
$(".graficax4").click(function(event) {
    var ruta;
    var leyenda = "Tiempo de Solución Incidentes por Tramo en Horas";
    var fechai = document.getElementById("finicial").value;
    var fechaf = document.getElementById("ffinal").value;
    if (fechai != "" && fechaf != "") {
        var nodo = $("#filtrox option:selected").val();
