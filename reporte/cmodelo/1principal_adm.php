<?php include('revisar_sesion.php')?>
<doctype html>
<html>
<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<title>Gestion de Problemas - Dashboard</title>
...
<?php include('encabezado.php')?> 
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		...
		<div class="container-fluid">
				...
				<a class="navbar-brand" href="#"><span>GESTION </span>PROBLEMAS</a>
				
			
				
			<!-- Notificaciones panel superior derecho -->
				<ul class="nav navbar-top-links navbar-right">
						...
						<ul class="dropdown-menu dropdown-messages">
							<li>
								<div class="dropdown-messages-box"><a href="profile.html" class="pull-left">
									<img alt="image" class="img-circle" src="http://placehold.it/50/30a5ff/fff">
									</a>
									<div class="message-body"><small class="pull-right">Last Login: 3 mins ago</small>
					...
					<!-- Notificaciones Incidentes y Problemas-->
					...
					<li class="dropdown"><a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
						...
						<ul class="dropdown-menu dropdown-alerts">
							<li><a href="#">
								<div><em class="fa fa-envelope"></em> Incidentes Nuevos Hoy
									<span class="pull-right text-muted small">3 mins ago</span></div>
							</a></li>
							<li class="divider"></li>
							<li><a href="#">
								<div><em class="fa fa-heart"></em> Incidentes Ejecutados Hoy: 
									<span class="pull-right text-muted small">4 mins ago</span></div>
							</a></li>
							<li class="divider"></li>
							<li><a href="#">
								<div><em class="fa fa-user"></em> Problemas Nuevos Hoy: 
									<span class="pull-right text-muted small">4 mins ago</span></div>
							</a></li>
						</ul>
					</li>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="pane panel-container">
			<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<p class="back-link"><a href="https://mc.net.co">Media commerce </a>2021</p>
			</div>
		</div><!--/.row-->
	</div>	<!--/.main-->
