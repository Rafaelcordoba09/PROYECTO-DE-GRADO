...
<html>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.js"></script>
    ...
    <script type="text/javascript">
      function excel()
      {
        ...
        if(fi!=""&&ff!="")
            {
              window.open('excel.php?fi='+fi+'&&ff='+ff, '_blank');
            }
        else
            {
              alert("Debe Elegir Fecha Inicial y Final");
            }
      }
    </script>
    </head>
  <body>
    <div class="bg"></div>
    <div class="block">
       <input type="button" class="button graficax1" value="Exportar a Excel" onclick="excel()">
       </div>
